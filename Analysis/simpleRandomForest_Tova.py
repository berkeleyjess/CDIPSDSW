...
for df in [train_df, test_df]:
    ...
    #for of in df['online_for']:
    #    of = of / np.timedelta64(1, 'h')
    ...
    #for li in df['last_impression']:
    #    li = li / np.timedelta64(1, 'h')
...
train_df = train_df.drop(['clicked','client', 'id', 'last_impression_time', 'last_seen_online_time', 'lesson_id', 'lesson_subject', 'time_clicked', 'time_clicked_score', 'time_sent_success', 'timezone', 'tutor_id'], axis=1)
